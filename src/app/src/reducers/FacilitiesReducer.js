...
const handleFetchSingleFacility = (state, payload) => {
    ...
    const shouldReplaceAllFacilities =
...
const clearFacilitiesDataOnFilterChange = state =>
    update(state, {
        facilities: {
            data: { $set: null },
        },
...
export default createReducer(
    {
        ...
        [failFetchNextPageOfFacilities]: state =>
            update(state, {
                facilities: {
                    isInfiniteLoading: { $set: false },
                },
            }),
        [completeFetchNextPageOfFacilities]: (state, payload) =>
            update(state, {
                facilities: {
                    fetching: { $set: false },
                    error: { $set: null },
