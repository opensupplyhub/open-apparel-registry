...
export default createReducer(
    {
        [updateFileUploadName]: (state, payload) =>
            update(state, {
                form: {
                    name: { $set: payload },
                },
        ...
        [updateFileUploadDescription]: (state, payload) =>
            update(state, {
                form: {
        ...
        [updateFileUploadFileName]: (state, payload) =>
            update(state, {
                form: {
        ...
        [updateFileUploadListToReplaceID]: (state, payload) =>
            update(state, {
                form: {
