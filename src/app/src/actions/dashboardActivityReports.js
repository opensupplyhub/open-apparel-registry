...
export const failFetchDashboardActivityReports = createAction('FAIL_FETCH_DASHBOARD_ACTIVITY_REPORTS');
export const completeFetchDashboardActivityReports = createAction('COMPLETE_FETCH_DASHBOARD_ACTIVITY_REPORTS');
...
export function fetchDashboardActivityReports() {
    return (dispatch) => {
        ...
        return apiRequest
            ...
            .then(({ data }) => dispatch(completeFetchDashboardActivityReports(data)))
            .catch(err =>
                dispatch(
                    logErrorAndDispatchFailure(
                        err,
...
export const startUpdateDashboardActivityReport = createAction('START_UPDATE_DASHBOARD_ACTIVITY_REPORT');
export const failUpdateDashboardActivityReport = createAction('FAIL_UPDATE_DASHBOARD_ACTIVITY_REPORT');
export const completeUpdateDashboardActivityReport = createAction('COMPLETE_UPDATE_DASHBOARD_ACTIVITY_REPORT');
...
export function rejectDashboardActivityReport({ id, statusChangeReason }) {
    return (dispatch) => {
        ...
        return apiRequest
            ...
            .then(({ data }) => dispatch(completeUpdateDashboardActivityReport(data)))
            .catch(err =>
                dispatch(
                    logErrorAndDispatchFailure(
                        err,
