...
export const startFetchSingleFacilityClaim = createAction('START_FETCH_SINGLE_FACILITY_CLAIM');
export const failFetchSingleFacilityClaim = createAction('FAIL_FETCH_SINGLE_FACILITY_CLAIM');
export const completeFetchSingleFacilityClaim =
    createAction('COMPLETE_FETCH_SINGLE_FACILITY_CLAIM');
export const clearSingleFacilityClaim = createAction('CLEAR_SINGLE_FACILITY_CLAIM');
...
export const startApproveFacilityClaim = createAction('START_APPROVE_FACILITY_CLAIM');
export const startDenyFacilityClaim = createAction('START_DENY_FACILITY_CLAIM');
export const startRevokeFacilityClaim = createAction('START_REVOKE_FACILITY_CLAIM');
export const failApproveFacilityClaim = createAction('FAIL_APPROVE_FACILITY_CLAIM');
export const failDenyFacilityClaim = createAction('FAIL_DENY_FACILITY_CLAIM');
export const failRevokeFacilityClaim = createAction('FAIL_REVOKE_FACILITY_CLAIM');
export const completeApproveFacilityClaim = createAction('COMPLETE_APPROVE_FACILITY_CLAIM');
export const completeDenyFacilityClaim = createAction('COMPLETE_DENY_FACILITY_CLAIM');
export const completeRevokeFacilityClaim = createAction('COMPLETE_REVOKE_FACILITY_CLAIM');
export const resetFacilityClaimControls = createAction('RESET_FACILITY_CLAIM_CONTROLS');
...
export const startAddNewFacilityClaimReviewNote =
    createAction('START_ADD_NEW_FACILITY_CLAIM_REVIEW_NOTE');
export const failAddNewFacilityClaimReviewNote =
    createAction('FAIL_ADD_NEW_FACILITY_CLAIM_REVIEW_NOTE');
export const completeAddNewFacilityClaimReviewNote =
    createAction('COMPLETE_ADD_NEW_FACILITY_CLAIM_REVIEW_NOTE');
export const clearFacilityClaimReviewNote = createAction('CLEAR_FACILITY_CLAIM_REVIEW_NOTE');
export const updateFacilityClaimReviewNote = createAction('UPDATE_FACILITY_CLAIM_REVIEW_NOTE');
