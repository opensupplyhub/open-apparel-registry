...
export const startFetchUserFacilityLists = createAction(
    'START_FETCH_USER_FACILITY_LISTS',
);
export const failFetchUserFacilityLists = createAction(
    'FAIL_FETCH_USER_FACILITY_LISTS',
);
export const completeFetchUserFacilityLists = createAction(
    'COMPLETE_FETCH_USER_FACILITY_LISTS',
);
