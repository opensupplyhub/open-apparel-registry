  ...
  render() {
    return (
      ...
      >
        ...
        <p>
          In order to access this beta, please enter the password provided to you
          by an administrator.
        </p>
        <input
          type="password"
        ...
        />
        <button onClick={ this.login } style={{ float: 'right', height: '24px' }} type="button">Enter Beta</button>
      </div>
    )
  }
}
