...
class ResetPwEmail extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <div role="presentation" className="margin-bottom-64 link-underline cursor" onClick={ () => this.handleOpen() }>
        ...
        >
          ...
          <DialogContent>
            ...
            />
            { error
              && (<div style={{ color: 'red' }}>Email address is invalid.</div>)
            }
          </DialogContent>
          <DialogActions>
            ...
            <MaterialButton disabled={ error } onClick={ this.sendEmail } color="primary">
...
export default connect(mapStateToProps, mapDispatchToProps)(ResetPwEmail)
