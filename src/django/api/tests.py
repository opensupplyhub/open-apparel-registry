...
class FacilityDownloadTest(FacilityAPITestCaseBase):
    ...
    def test_extended_fields(self):
        ...
        response = self.get_facility_download(params)
        base_row = self.get_rows(response)[0]
        contribution = '[test contributor 1 (First List)]'
        row = [self.facility.id, self.date, 'Name',
               'Address', 'US', 'United States', 0.0, 0.0,
               f'Apparel {contribution}',
               'test contributor 1 (First List)',
               f'100-5000 {contribution}',
               f'Contributor {contribution}',
               f'biological recycling {contribution}',
               f'Raw Material Processing or Production {contribution}',
               f'Biological Recycling {contribution}',
               f'Shirts {contribution}', 'False']
    ...
    def test_claim_base_row(self):
        ...
        contribution = '[test contributor 1 (Claimed)]'
        row = [
    ...
    def test_handles_additional_list_items(self):
        ...
        contribution = '[test contributor 1 (API)]'
        row = [
            ...
            f'0-100 {contribution}',
            f'Contributor A {contribution}',
            f'biological recycling {contribution}',
            f'Raw Material Processing or Production {contribution}',
            f'Biological Recycling {contribution}',
            f'a {contribution}', 'False']
        print(rows[0])
    ...
    def test_inactive_source_is_anonymized(self):
        ...
        row = [
            ...
            '42 Dolphin St', 'US', 'United States', 0.0, 0.0,
            'Apparel [test contributor 1 (First List)]|' +
            'Apparel [An Other (API)]',
            'test contributor 1 (First List)|An Other (API)',
            '0-100 [An Other (API)]', 'Contributor A [An Other (API)]',
            'biological recycling [An Other (API)]',
            'Raw Material Processing or Production [An Other (API)]',
            'Biological Recycling [An Other (API)]',
            'a [An Other (API)]', 'False']
        self.assertEquals(rows[0], row)
