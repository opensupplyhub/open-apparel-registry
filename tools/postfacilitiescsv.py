...
parser.add_argument('-i', '--id',
                    type=int,
                    help='Identfier passed as a query string argument',
                    default=1)

args = parser.parse_args()

URL = '{}/api/facilities/?id={}&index=||||&create=false&textonlyfallback=true'.format(args.rooturl, args.id);
...
with open(args.csv, 'r') as f:
    ...
    for row in reader:
        ...
        try:
            ...
            response = requests.post(URL.replace('||||', str(count)), json=data, headers={
